				...
				<ul>
					<li>
						...
						<div class="rect02">
							...
							<input type="text" class="inputField inputId" name="inverterId" placeholder="인버터 ID" />
							<input type="button" class="btn overlap" data-inverterid-check-btn="" value="중복확인">
							<p class="text-success text-desc text-warning inverterIdDesc"></p> 
						</div>
					</li>
					<li class="clearfix">
						<div class="rect01">
							<label class="title">인버터 모델명</label>
							<input type="text" class="inputField" name="inverterName" placeholder="인버터 모델명" />
							<p class="text-desc text-warning inverterNameDesc"></p> 
						</div>
						<div class="rect02">
							<label class="title">인버터 용량(kW)</label>
							<input type="text" class="inputField" name="capacity" placeholder="인버터 용량(kW)" />
					...
					<li>
						<div class="rect01">
							...
							<input type="text" class="inputField num" name="phone" placeholder="000-0000-0000" maxlength="13"/>
...
<script src="${res }/inverter/js/inverterReg.js"></script>